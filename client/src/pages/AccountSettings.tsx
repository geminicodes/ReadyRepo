...
export default function AccountSettings() {
  ...
  const openWaitlist = () => window.open("https://tally.so/r/Gx1gBQ", "_blank", "noopener,noreferrer");
        ...
        <div className="space-y-6">
          ...
          <Card className="glass border-white/10 bg-background/60 backdrop-blur-xl">
            ...
            <CardContent className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              {tier === "free" ? (
                <Button variant="hero" onClick={openWaitlist}>Upgrade to Pro</Button>
              ) : null}
            </CardContent>
          </Card>
          ...
          <Card className="glass border-white/10 bg-background/60 backdrop-blur-xl">
            ...
            <CardContent className="space-y-5">
              <div className="text-sm text-muted-foreground">
                This MVP uses <span className="font-medium text-foreground">GitHub sign-in</span> only. Password management is handled by GitHub.
              </div>
