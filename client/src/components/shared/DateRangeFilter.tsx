...
export function DateRangeFilter({ value, customRange, onChange }: DateRangeFilterProps) {
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-fit min-w-[10rem] max-w-[calc(100vw-2rem)] p-0" align="start">
        <div className="p-2">
          {!showCalendar ? (
            <div className="space-y-1">
              {presets.map((preset) => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-md text-sm whitespace-normal break-words leading-snug transition-colors ${
                    value === preset.value
